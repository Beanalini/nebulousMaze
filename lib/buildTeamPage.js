...
const renderMan = (manager) => {
   ...
   let managerHTML = `<div class="card staff-card col-1 col-sm-2 col-lg-3 mb-3 h-100">
...
const renderEng = (engineer) => {
   ...
   let engineerHTML = `<div class="card staff-card col-1 col-sm-2 col-lg-3 mb-3 h-100">
...
const renderInt = (intern) => {
   ...
   let internHTML = `<div class="card staff-card col-1 col-sm-2 col-lg-3 mb-3 h-100">
